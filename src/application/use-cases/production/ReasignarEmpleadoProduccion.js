...
class ReasignarEmpleadoProduccion {
    ...
    async execute(ordenId, nuevoEmpleadoId, motivo, solicitante = {}) {
        ...
        // ✅ Fix: pasar id_usuario y nombre del solicitante al historial.
        // Antes se pasaban null, por lo que el historial no registraba quién
        // realizó la reasignación (guardaba el ID nada más, sin nombre).
