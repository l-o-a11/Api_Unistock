...
class ProductionRepository {
  ...
  // Cuenta órdenes de producción activas (no enviadas/anuladas y sin etapa
  // confirmada) asignadas a un empleado. Usado por users (toggleStatus y
  // DeleteUser) para no inactivar/eliminar a alguien con producción en curso.
